...
window.TrendLab = (function () {
  ...
  async function setTicker(ticker) {
    ...
    try {
      ...
      showMsg(isIntl
        ? '⚠️ Το γράφημα τάσης δεν είναι ακόμα διαθέσιμο για διεθνείς μετοχές (' + ticker + ') — η πηγή ιστορικού μας καλύπτει προς το παρόν μόνο ΗΠΑ. Τα υπόλοιπα στοιχεία (θεμελιώδη, Quest, ειδήσεις) δουλεύουν κανονικά από το modal.'
        : '⚠️ Δεν φόρτωσε το ιστορικό για ' + ticker + ' (' + (e.message || e) + '). Δοκίμασε ξανά σε λίγο.');
    }
  }
