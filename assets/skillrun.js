...
window.SkillRun = (function () {
  ...
  function ensureSkeleton() {
    ...
    wrap.innerHTML = `
      ...
      <div id="sr-body"></div>
      <div class="note">⚠️ Οι προτάσεις εδώ προέρχονται από ζωντανή έρευνα (ειδήσεις, καταλύτες, τεχνικά επίπεδα) που κάνει ο Claude όταν του ζητηθεί να τρέξει το <code>/swing-trade-scout</code> — δεν ανανεώνονται αυτόματα σαν τις υπόλοιπες καρτέλες. Το κουμπί απλά ξαναφορτώνει ό,τι πιο πρόσφατο έχει αποθηκευτεί. <b>Δεν</b> είναι επενδυτική συμβουλή ούτε εγγύηση — δικιά σου έρευνα/απόφαση για μέγεθος θέσης και ρίσκο.</div>`;
